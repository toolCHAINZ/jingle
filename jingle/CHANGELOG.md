...
- detect aliasing of accesses with shared base pointers  ([#296](https://github.com/toolCHAINZ/jingle/pull/296))
...
- allow accessing location state as mut ([#284](https://github.com/toolCHAINZ/jingle/pull/284))
...
- reduce redundant simplification in value analysis ([#268](https://github.com/toolCHAINZ/jingle/pull/268))

## [0.6.23](https://github.com/toolCHAINZ/jingle/compare/jingle-v0.6.22...jingle-v0.6.23) - 2026-05-07
...
- implement remaining boolean operations ([#249](https://github.com/toolCHAINZ/jingle/pull/249))
...
- consistent if-else structuring ([#220](https://github.com/toolCHAINZ/jingle/pull/220))
...
- eliminate all cloning in the main CPA loop and generic merge impls ([#203](https://github.com/toolCHAINZ/jingle/pull/203))
...
## [0.6.1](https://github.com/toolCHAINZ/jingle/compare/jingle-v0.6.0...jingle-v0.6.1) - 2026-02-23

### Other

- fallthrough counting mode to bounded branch analysis ([#197](https://github.com/toolCHAINZ/jingle/pull/197))
...
- Refactor SimpleValue to store sizes and consts as VarNodes ([#160](https://github.com/toolCHAINZ/jingle/pull/160))

## [0.5.4](https://github.com/toolCHAINZ/jingle/compare/jingle-v0.5.3...jingle-v0.5.4) - 2026-02-11

### Added

- hash-consing of expressions, logging tweaks, cfg refactors ([#159](https://github.com/toolCHAINZ/jingle/pull/159))
